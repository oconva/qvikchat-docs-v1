...
To get up and running quickly, you can use the QvikChat starter template. The starter template is a pre-configured project with all the necessary configurations and setup to get you started with QvikChat. It also includes the setup for TypeScript, ESLint, Prettier, Jest and more, and uses SWC for faster compilation.

Simply, clone the [QvikChat starter template](https://github.com/oconva/qvikchat-starter-template.git) to get started.
