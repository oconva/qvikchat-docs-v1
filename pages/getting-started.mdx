...
Running the above code will run a <Link href="https://expressjs.com/" target="_blank" className="text-primary hover:text-primary-hover">Express</Link> server with your defined chat endpoint accessible through it.
